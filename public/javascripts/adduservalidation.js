...
function showErrorMessage(message){
    ...
    // errorElement.innerHTML = `<div class="alert alert-warning alert-dismissible fade show" role="alert">${message}<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>`
}
function submitform(e){
    ...
    if(fpassword.value.length <2){
        showErrorMessage("Password must be longer than 2 Characters");
        return false;
    }
